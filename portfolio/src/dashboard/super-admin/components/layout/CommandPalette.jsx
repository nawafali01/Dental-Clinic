      ...
      >
            ...
            filteredItems.map((item, idx) => {
              ...
              return (
                <button
                  ...
                  className="w-full flex items-center justify-between px-3 py-2.5 rounded-xl hover:bg-slate-100:bg-slate-800/70 text-left group transition-colors"
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-sm font-medium text-slate-800 group-hover:text-slate-900:text-white">
                        {item.title}
                      </div>
        ...
        <div className="px-4 py-2.5 bg-slate-50 border-t border-slate-200 flex items-center justify-between text-xs text-slate-400">
          <div className="flex items-center gap-2">
            <span className="px-1.5 py-0.5 rounded bg-slate-200 font-mono text-[10px] text-slate-600">
              ↑↓
            </span>
            <span>Navigate</span>
            <span className="px-1.5 py-0.5 rounded bg-slate-200 font-mono text-[10px] text-slate-600">
