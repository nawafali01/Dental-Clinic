...
import { X, Search, Expand, ArrowRight } from "lucide-react";
...
export default function Gallery() {
  ...
  const [sliderVal, setSliderVal] = useState(50); // percentage of slider position
      ...
      <section className="pb-8">
        <div className="max-w-7xl mx-auto px-5 md:px-8">
          <div className="flex flex-wrap justify-center gap-2">
            {["All", "Clinic", "Treatment Rooms", "Equipment"].map(cat => (
              <button
                key={cat}
