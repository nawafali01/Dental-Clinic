...
const fallbackDoctors = [
  { _id: "1", name: "Dr. Catherine Reyes", role: "Cosmetic & Restorative Dentist", edu: "DDS, Columbia University", exp: "12 years", img: doctor1, category: "Cosmetic", certs: ["Invisalign Diamond Provider", "AACD Accredited"] },
  { _id: "2", name: "Dr. Marcus Vance", role: "Implant & Oral Surgeon", edu: "DDS, PhD, Harvard Dental", exp: "15 years", img: doctor2, category: "Implantology", certs: ["Board Certified Oral Surgeon", "ICOI Fellow"] },
  { _id: "3", name: "Dr. Sarah Kim", role: "Pediatric Specialist", edu: "DMD, University of Pennsylvania", exp: "9 years", img: doctor3, category: "Pediatric", certs: ["AAPD Member", "Laser Dentistry Certified"] },
];

const categories = ["All", "Cosmetic", "Implantology", "Pediatric", "General"];
      ...
      try {
        ...
        if (items && items.length > 0) {
          const normalized = items.map((doc, idx) => {
            ...
            // Inject search category and certs if backend doesn't supply them
            return {
