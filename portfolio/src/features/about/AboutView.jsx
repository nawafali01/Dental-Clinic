      ...
      <section className="relative pb-18 md:pb-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-5 md:px-8 text-center">
          ...
          >
            <Button
              asChild
              className="group rounded-full h-12 px-6 bg-primary hover:bg-primary/95 text-primary-foreground shadow-[0_14px_40px_-12px_rgba(31,138,112,0.65)] transition-all"
            >
              <a href="/services">
                Explore Services{" "}
          ...
          >
            {values.map((v) => (
              <motion.div
                ...
                key={v.title}
                className="rounded-3xl bg-white border border-border p-8 soft-shadow hover:border-primary/40 transition-colors"
              >
              ...
              <Reveal key={t.year} delay={idx * 0.08}>
                ...
                >
                  <div className="md:w-1/2 p-6 rounded-3xl bg-white border border-border soft-shadow ml-10 md:ml-0 md:mx-6">
                    ...
                    <h3 className="font-display font-semibold text-xl text-secondary mt-1">
                      {t.title}
                    </h3>
